 ...
 *
 * @param {IconData[]} icons - List of all available icons.
 * @param {string[]} sizes - Array of sizes in "WxH" format (e.g., "32x32").
 ...
 *
 * @param {IconData[]} icons - List of icons.
 * @param {string[]} size - Size in "WxH" format (e.g., "270x270").
