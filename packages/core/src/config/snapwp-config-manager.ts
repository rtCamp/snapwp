...
const envConfig = (): Partial< SnapWPEnv > => ( {
	...
	corsProxyPrefix: process.env.CORS_PROXY_PREFIX,
	frontendUrl: process.env.FRONTEND_URL,
	graphqlEndpoint: process.env.GRAPHQL_ENDPOINT,
	wpHomeUrl: process.env.WP_HOME_URL,
	restUrlPrefix: process.env.REST_URL_PREFIX,
	// If `wpSiteUrl` is not provided, use `wpHomeUrl`.
	wpSiteUrl: process.env.WP_SITE_URL || process.env.WP_HOME_URL,
	uploadsDirectory: process.env.WP_UPLOADS_DIRECTORY,
