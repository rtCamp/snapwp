...
export default function generateGraphqlUrl(
	...
	// Adding extra check because there is high chances of process.env.NEXT_PUBLIC_WP_HOME_URL and process.env.NEXT_PUBLIC_WP_GRAPHQL_ENDPOINT being undefined
	if ( ! homeUrl ) {
